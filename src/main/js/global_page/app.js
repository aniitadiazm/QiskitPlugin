...
function init() {
  el.innerHTML = `
<div class="page page-limited qiskit-global_page">
  <button class="button button-red" id="qiskit-global_page--button">Do not click me</button>
</div>
`;
  document
    .getElementById("qiskit-global_page--button")
