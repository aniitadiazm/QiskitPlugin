...
//
//  You can access it at /project/extension/qiskit/project_page?id={COMPONENT_ID}
window.registerExtension('qiskit/project_page', function (options) {
  // options.el contains the DOM node we can use for our app. Prepare our node
  // so our Backbone View can correctly target it.
  options.el.innerHTML = `<div class="page page-limited" id="qiskit-project_page">Loading...</div>`;
