          ...
          <tbody>
            <tr>
              <td className="code-name-cell">
                {window.tp(
                  "qiskit.admin_page.we_have_x_y",
                  this.state.numberOfQualityProfiles,
                  window.t("qiskit.admin_page.quality_profiles")
                )}
              </td>
            </tr>
            <tr>
              <td className="code-name-cell">
                {window.tp(
                  ...
                  window.t("qiskit.admin_page.quality_gates")
                )}
              </td>
            </tr>
            <tr>
              <td className="code-name-cell">
                {window.tp(
                  ...
                  window.t("qiskit.admin_page.issues")
                )}
              </td>
            </tr>
            <tr>
              <td className="code-name-cell">
                {window.tp(
                  ...
                  window.t("qiskit.admin_page.projects")
                )}
              </td>
            </tr>
          </tbody>
