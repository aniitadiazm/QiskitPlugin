          ...
          <thead>
            <tr className="code-components-header">
              <th className="thin nowrap text-center code-components-cell">
                {window.t("qiskit.portfolio_page.qg")}
              </th>
              <th className="thin nowrap text-right code-components-cell">
                {window.t("qiskit.portfolio_page.bugs")}
              </th>
              <th className="thin nowrap text-right code-components-cell">
                {window.t("qiskit.portfolio_page.reliability_rating")}
              </th>

              <th className="thin nowrap text-right code-components-cell">
                {window.t("qiskit.portfolio_page.vulnerabilities")}
              </th>
              <th className="thin nowrap text-right code-components-cell">
                {window.t("qiskit.portfolio_page.security_rating")}
              </th>

              <th className="thin nowrap text-right code-components-cell">
                {window.t("qiskit.portfolio_page.code_smells_effort")}
              </th>
              <th className="thin nowrap text-right code-components-cell">
                {window.t("qiskit.portfolio_page.maintainability_rating")}
              </th>
            </tr>
          </thead>
          <tbody>
